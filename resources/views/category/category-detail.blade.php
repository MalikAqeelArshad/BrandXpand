...
<script type="text/javascript">
    var page = 1, flag = true, loading = false;
...
<main class="site-content">
    <section class="py-5">
        <div class="text-center">
            <h2 class="font-weight-bold mb-0">{{ $subCategory->category->name }}</h2>
            <small class="text-danger">{{ $subCategory->name }}</small>
        </div>
                ...
                <div class="col-lg-3 col-sm-4 col-6 mb-4 d-flex flex-column item">
                    <a class="mb-1 text-dark weight-md" href="{{ route('product.detail',$product->id) }}">
                        <figure class="transition-all text-center shadow-sm border border-light p-2 mb-2">
                            <img src="{{ asset('uploads/products/large/'.$product->image) }}" class="img-fluid">
                        </figure>
