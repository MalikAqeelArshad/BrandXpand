<div class="d-flex flex-column item @isset ($class) {{ $class }} @else col-lg-3 col-sm-4 col-6 mb-4 @endisset">
    ...
    <button type="button" class="addToCart btn btn-block btn-brand rounded-pill size-sm" value="{{ $product->id }}" data-attrs="{{ $product->attrs }}">
        Add to Cart
    </button>
</div>